...
namespace mesh {
    ...
    public:
        ...
        /* input is a file name for stl model, and a scale value.
            It will generate a connected model while the coordinates of each vertex 
            will be scaled */
